...
fn parse_context(s: &str) -> Option<KeyContext> {
    match s {
        ...
        "command_prompt" => Some(KeyContext::CommandPrompt),
        "filter_prompt" => Some(KeyContext::FilterPrompt),
        _ => None,
    }
}
...
fn parse_action_id(s: &str) -> Option<KeyActionId> {
    match s {
        ...
        "toggle_filter" => Some(KeyActionId::ToggleFilter),
        "toggle_journal" => Some(KeyActionId::ToggleJournal),
        "toggle_filter_prompt" => Some(KeyActionId::ToggleFilterPrompt),
        "toggle_command_prompt" => Some(KeyActionId::ToggleCommandPrompt),
        "toggle_help" => Some(KeyActionId::ToggleHelp),
        "toggle_date_interface" => Some(KeyActionId::ToggleDateInterface),
        "toggle_project_interface" => Some(KeyActionId::ToggleProjectInterface),
        ...
        "selection_jump_to_first" => Some(KeyActionId::SelectionJumpToFirst),
